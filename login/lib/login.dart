...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<Map<String, dynamic>> login(String username, String password) async {
    ...
    if (username.isEmpty || !RegExp(r'^[^@]+@[^@]+\.[^@]+').hasMatch(username)) {
  ...
  void _handleLogin() async {
    ...
    if (response.containsKey('error')) {
      ...
      // Proceed to another screen or save token, etc.
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: _handleLogin, // Enable login only when data is loaded
                        child: Text("Login"),
                      ),
                      SizedBox(width: 20,),
                      ElevatedButton(
